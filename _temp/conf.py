...
html_short_title = "Test navigation bar title"
...
html_sidebars = {
   ...
   'using/windows': ['windowssidebar.html', 'localtoc.html', 'relations.html', 'searchbox.html'],
}
# Additional templates that should be rendered to pages, maps page names to
# template names.
#html_additional_pages = {'globaltoc.html'}
