...
.. TO ADD
 .. note:: Given the feature is enabled, you can find contact details of the assigned sales representative in the footer of the front store page.
...
.. note:: The types of options available are subject to the type of data contained in the table.
